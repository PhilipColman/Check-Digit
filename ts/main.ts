const locationHTML = document.getElementById('location') as HTMLInputElement;
const spokenHTML = document.getElementById('spoken') as HTMLParagraphElement;
const checkDigitHTML = document.getElementById('checkDigit') as HTMLParamElement;
...
locationHTML.addEventListener("input", () => {
    ...
    if (!(location == "RETURNS" || location == "RETURN" || location == "RETUR")) locationHTML.value = locationHTML.value.substring(0, 4);
